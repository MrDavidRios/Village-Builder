...
public class LowPolyClouds : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        offsetPosition = new Vector3(offsetPosition.x + (float) terrainGenerator.worldSize / 2,
            offsetPosition.y,
            offsetPosition.z + (float) terrainGenerator.worldSize / 2);
    ...
    [SerializeField] private float m_cloudSize = 1;
    [SerializeField] private float m_maxScale = 1;
    [SerializeField] private float m_timeScale = 0.05f;
    [SerializeField] private float m_texScale = 0.1f;
    [SerializeField] private float m_minNoiseSize = 0.6f;
    [SerializeField] private float m_scaleSize = 1.5f;
    [SerializeField] private int m_cloudsCount = 100;
