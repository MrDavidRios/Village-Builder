...
namespace DavidRios.Assets.Scripts.Villager
{
    public static class JobUtils
    {
        ...
        public static int VillagerToAssignTo(List<VillagerLogic> villagers, string jobType)
        {
            var eligibleVillagers = new List<VillagerLogic>();
        ...
        public static bool DetermineIfVillagerQualified(VillagerLogic villagerLogic, string jobType)
        {
            switch (jobType)
            {
                case "Move":
                ...
                case "Chop":
                case "HarvestTree":
                    return villagerLogic.role == "Laborer";
                case "HarvestStone":
                case "Mine":
                    return villagerLogic.role == "Laborer";
                case "Build":
                    return villagerLogic.role == "Laborer" || villagerLogic.role == "Carpenter";
                case "Withdraw":
                case "Deposit":
        ...
        /// <returns></returns>
        public static VillagerLogic ReturnVillagerFromJobTransform(List<VillagerLogic> villagers, Transform jobTransform)
        {
        ...
        public static Transform[] GetNearestAvailableStorages(VillagerLogic villagerLogic, string itemType, int itemAmount,
            bool deposit = true)
        {
